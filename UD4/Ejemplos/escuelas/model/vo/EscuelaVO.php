...
class EscuelaVO implements Vo{
    ...
    public function toArray(): array
    {
        return [
            ...
            'horaApertura' => $this->convertirHora($this->horaApertura),
            'horaCierre' => $this->convertirHora($this->horaCierre),
            'comedor' => $this->comedor,
        ];
    }

    public static function fromArray(array $data):EscuelaVO
    {
    ...
    public  function updateVoParams(Vo $vo){
        $this->setHoraApertura($this->horaApertura);
        $this->setHoraCierre($this->horaCierre);
        $this->nombre = $vo->getNombre() ?? $this->nombre;
        $this->direccion = $vo->getDireccion() ?? $this->direccion;
        $this->codMunicipio = $vo->getCodMunicipio() ?? $this->codMunicipio;
        $this->horaApertura = $vo->getHoraApertura() ?? $this->horaApertura;
        $this->horaCierre = $vo->getHoraCierre() ?? $this->horaCierre;
        $this->comedor = $vo->getComedor() ?? $this->comedor;
