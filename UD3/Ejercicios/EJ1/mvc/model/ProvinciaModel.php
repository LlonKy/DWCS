...
use Ejercicios\EJ1\mvc\model\vo\Provincia;
...
class ProvinciaModel extends Model
{
     ...
     */
    public static function getById(int $id): ?Provincia
    {
     ...
     */
    public static function add(Provincia $vo): Provincia|false
    {
     ...
     */
    public static function update(Provincia $vo): Provincia|false
    {
        if ($vo->getCodProvincia() === null)
            return false;
     ...
     */
    private static function rowToVO(array $row): Provincia
    {
